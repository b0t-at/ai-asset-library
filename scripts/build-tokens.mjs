...
const banner = `/* b0t design tokens — generated by scripts/build-tokens.mjs. Do not edit by hand. */`;
...
function tailwindTheme() {
  const lines = [];
  lines.push(`/* b0t Tailwind v4 theme — generated by scripts/build-tokens.mjs. Do not edit by hand.
 *
 *   @import "tailwindcss";
 *   @import "@b0t-at/design/css/tokens.css";   (or the CDN URL, see docs/for-agents.md)
 ...
 * The default Tailwind palette is disabled so product UI can only use b0t colors.
 */
@theme {
  --color-*: initial;
  --font-*: initial;
...
@theme inline {`);
  ...
  for (const [k, t] of flattenTokens(layout.breakpoint, ["layout.breakpoint"])) {
    // Breakpoints cannot be variables (used in media queries) — inline the value.
...
const distJson = JSON.stringify({ prefix: PREFIX, tokens: flat }, null, 2) + "\n";
const distMjs = `// b0t design tokens — generated. Do not edit by hand.
...
const bundle =
  `/* b0t.css — single-file bundle (tokens + base + components + utilities). Generated. */\n\n` +
  tokensCss +
  "\n" +
  bundleParts
